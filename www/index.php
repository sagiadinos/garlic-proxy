...
try
{
	...
	$UserAgent   = new \Garlic\helper\UserAgent();
	...
	{
		$Controller = new \Garlic\controller\PlayerController($PlayerModel, $Configuration, $UserAgent);
		$Controller->dispatch();
	}
	else // user Browser
	{
		$Controller = new \Garlic\controller\ViewController($PlayerModel, $Configuration);
